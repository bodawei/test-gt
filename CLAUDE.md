...
**YOU ARE IN: `tst/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/tst/` (rig root) or other directories
...
**Your mail address:** `tst/polecats/obsidian`
**Your rig:** tst
**Your Witness:** `tst/witness`
...
| Ask Witness for help | `gt mail send tst/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`tst/witness`) when:
...
```bash
gt mail send tst/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
